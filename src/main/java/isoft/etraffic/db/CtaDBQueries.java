...
public class CtaDBQueries {
	...
	public void getTFandTLforsuspend() throws SQLException, InterruptedException, ClassNotFoundException {
		setConnection();
		Statement SQLStatement = con.createStatement();
		// step4 execute query
		ResultSet rs = SQLStatement.executeQuery(
