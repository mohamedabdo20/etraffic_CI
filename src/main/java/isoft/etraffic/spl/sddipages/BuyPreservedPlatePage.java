...
public class BuyPreservedPlatePage extends SeleniumWraper {
	...
	public void buyPreservedPlatePage() throws InterruptedException, ClassNotFoundException, SQLException {
		...
		String PlateCode = dbQueries.PlateCode;
		writeToElement(plateCode, PlateCode);
		String PlateNo = dbQueries.PlateNo;
	...
	public BuyPreservedPlatePage(WebDriver driver) {
		super(driver);
