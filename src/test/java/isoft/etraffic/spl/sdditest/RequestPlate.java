...
import isoft.etraffic.spl.sddipages.*;


public class RequestPlate {
	
	WebDriver driver;
	String trafficFileNo = "10001001";
	...
	@Test
	public void requestplate() throws InterruptedException {
		
		commonPage = new CommonPageOnline(driver);
		commonPage.loginByTrafficFile(trafficFileNo);
		commonPage.gotoLicensing();
		
		RequestPlatePage RequestPlateobject = new RequestPlatePage(driver);
		RequestPlateobject.requestPlatePage();
		...
		Thread.sleep(2000);
		RequestPlateobject.confirmProcess();
