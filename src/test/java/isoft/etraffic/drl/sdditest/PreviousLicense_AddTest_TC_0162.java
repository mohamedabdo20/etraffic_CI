...
import isoft.etraffic.drl.sddipages.PreviousLicensePage;
...
public class PreviousLicense_AddTest_TC_0162 {
	...
	public void renewFile() throws Exception {	
		...
		commonPage.gotoService("Define Held driving license");
		commonPage.startTransactionNew();
		
		previousLicensePage = new PreviousLicensePage(driver);
		previousLicensePage.addLicense("United States", "Texas");
