...
import isoft.etraffic.drl.sddipages.TransferTrafficFilePage;
import isoft.etraffic.testbase.TestBase;
import isoft.etraffic.vhl.sddipages.CommonPageOnline;

public class TransferTrafficFile_TC_0160 {
	String trafficFile = "14012324";
	DBQueries dbQueries = new DBQueries();
	WebDriver driver;
	CommonPageOnline commonPage;
	TransferTrafficFilePage transferTrafficFilePage;
	...
	public void renewFile() throws Exception {	
		...
		commonPage.clickByLinkTxt("Application Transfer");
		commonPage.startTransactionNew();
		
		transferTrafficFilePage = new TransferTrafficFilePage(driver);
		transferTrafficFilePage.selectCenter();
		transferTrafficFilePage.clickProceedBtn();
//		reissueLearningPermitPage.clickCollectAllDocumentChbox();
