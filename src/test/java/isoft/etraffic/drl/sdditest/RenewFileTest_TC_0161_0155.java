...
import isoft.etraffic.drl.sddipages.RenewFilePage;
import isoft.etraffic.testbase.TestBase;
import isoft.etraffic.vhl.sddipages.CommonPageOnline;

public class RenewFileTest_TC_0161_0155 {
	...
	public void renewFile() throws Exception {	
		...
		commonPage.selectTrustedAgentService("Renew a file");
		...
		renewFilePage = new RenewFilePage(driver);
		renewFilePage.renewTrf(trafficFile);
