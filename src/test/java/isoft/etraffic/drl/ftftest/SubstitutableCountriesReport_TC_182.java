...
public class SubstitutableCountriesReport_TC_182 {
	...
	public void changeFirstCountryProfessionsCount() throws ClassNotFoundException, InterruptedException, SQLException {
		...
		substitutableCountriesPage.openFirstCountryScreen();
		substitutableCountriesPage.clickShowOtherCountriesLicenses();
		substitutableCountriesPage.clickShowReportBtn();
		substitutableCountriesPage.switchToSecondWindow();
	}
