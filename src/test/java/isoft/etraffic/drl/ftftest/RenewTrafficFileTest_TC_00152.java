...
import isoft.etraffic.drl.ftfpages.RenewTrafficFilePage;
import isoft.etraffic.testbase.TestBase;
import isoft.etraffic.vhl.ftfpages.CommonPage;
import isoft.etraffic.vhl.ftfpages.LoginFTFPage;


public class RenewTrafficFileTest_TC_00152 {
	String trafficFileNo = "13845691";
	...
	RenewTrafficFilePage renewTrfFilrPage;
	List<String> transactionsLst = new ArrayList<String>();

	@Test
	public void renew() throws ClassNotFoundException, InterruptedException, SQLException {
		...
		renewTrfFilrPage = new RenewTrafficFilePage(driver);
		renewTrfFilrPage.proceedTrs();
