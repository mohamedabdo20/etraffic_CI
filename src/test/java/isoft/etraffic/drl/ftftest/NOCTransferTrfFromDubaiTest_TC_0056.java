...
public class NOCTransferTrfFromDubaiTest_TC_0056 {
	...
	public void issueNOC() throws ClassNotFoundException, InterruptedException, SQLException, AWTException {
		...
		trafficFileNo = dbQueries.gettrafficFile_TC_56();
		
		commonPage = new CommonPage(driver);
		commonPage.gotoHomePage();
		commonPage.gotoSmartServices();
		commonPage.searchByTRFFile(trafficFileNo);
		commonPage.gotoMainService("عدم ممانعة من نقل ملف من الإمارة");
