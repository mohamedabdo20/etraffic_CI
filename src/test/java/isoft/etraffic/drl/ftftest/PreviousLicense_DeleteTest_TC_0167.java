...
public class PreviousLicense_DeleteTest_TC_0167 {
	...
	@Test
	public void deleteLicense() throws ClassNotFoundException, InterruptedException, SQLException, AWTException {
		...
		previousLicensePage.deleteLicense();
