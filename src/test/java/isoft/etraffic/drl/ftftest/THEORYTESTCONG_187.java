...
public class THEORYTESTCONG_187 {
	...
	public void changeFirstCountryProfessionsCount() throws ClassNotFoundException, InterruptedException, SQLException {
		...
		driver.findElement(By.id("resultsTable:0:c4")).click();
		driver.findElement(By.id("actions1:editButtonId")).click();
		commonPage.clickElementJS(By.id("noOfReqDaysBeforeBooking:noOfReqDaysBeforeBooking"));
		commonPage.writeToElement(By.id("noOfReqDaysBeforeBooking:noOfReqDaysBeforeBooking"), "6");
