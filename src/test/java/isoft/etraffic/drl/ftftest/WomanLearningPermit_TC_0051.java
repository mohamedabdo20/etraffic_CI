...
public class WomanLearningPermit_TC_0051 {
	...
	@Test
	public void getWomanLearningPermit() throws ClassNotFoundException, InterruptedException, SQLException {
		loginPage = new LoginFTFPage(driver);
		loginPage.loginFTF(username, dbQueries.getUserPassword(username), center);

		trafficFileNo = dbQueries.gettrafficFile_TC_51();
		
		commonPage = new CommonPage(driver);
		commonPage.gotoSmartServices();
		commonPage.searchByTRFFile(trafficFileNo);
		commonPage.gotoStudentFileTab();
		commonPage.gotoStudentFileService("تصاريح مرورية");
