...
public class TransferPossesionCertificateTest {
	String certificateNo, testDateTime, newOwnerTrafficFile = "10184041";
	...
	public void replaceCertificate() throws Exception {
		...
		if (!commonPage.transactionFeesAssertion(170)) {
	...
	public void AfterClass() throws ClassNotFoundException, SQLException {
		...
		for (String trns : transactionsLst) {
			System.out.println("TransferPossesionCertificate FTF trns: " + trns);
		}
		assertTrue(dbQueries.checkVLDFeesEvent(VHLTransaction.VLD_CHANGE_POSS, testDateTime));
	}
}
