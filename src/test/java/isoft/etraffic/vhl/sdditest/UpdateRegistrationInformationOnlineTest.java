...
import isoft.etraffic.vhl.sddipages.UpdateRegistrationInformationPages;

public class UpdateRegistrationInformationOnlineTest {
	
	WebDriver driver;
	String trafficFileNo, plateNumber, plateCode, plateCategory, chassis, weight;
	DBQueries dbQueries = new DBQueries();
	CommonPageOnline commonPage;
	UpdateRegistrationInformationPages updateRegistrationInformationPages;
	...
	public void updateRegistrationInformation() throws Exception {
		...
		commonPage.gotoPlateService("Update Registration Information");
		
		updateRegistrationInformationPages = new UpdateRegistrationInformationPages(driver);
		updateRegistrationInformationPages.proceedTrs();
	...
	public void afterClass() {
		for (String trns : transactionsLst) {
			System.out.println("UpdateRegistrationInfo Online trns: " + trns);
		}
	}
}